...
*********************************************************************
     ...
     .      x,dNdx,EMIN,NBIN
      ...
      WRITE(17,900) 2,"5.5.1      # Version number"
...
*  From IF(OUTFLAG.NE.1)
     ...
     .    " # (STOP/SBOTTOM MASSES)"
      ...
      WRITE(17,899) "# 1606.02266 T.17, 1809.10733 T.8, 1909.02845 T.11"
      WRITE(17,899) "# 0.905 < CV < 1.000 " ! electroweak couplings
      WRITE(17,899) "# 0.959 < CU < 1.340 " ! top quark
      WRITE(17,899) "# 0.611 < CB < 0.917 " ! b quark
      WRITE(17,899) "# 0.836 < CJ < 1.076 " ! gluons
      WRITE(17,899) "# 0.858 < CG < 1.018 " ! photons
      WRITE(17,899) "# 0.779 < CL < 0.987 " ! taus
...
*  From IF(OUTFLAG.NE.1)
      ...
      WRITE(18,900) 2,"5.5.1      # Version number"
     ...
     . 'BR(t -> ~t_2 ~chi_50)'
      ...
      WRITE(19,900) 2,"5.5.1      # Version number"
      IF(PROB(30).GT.0d0)
